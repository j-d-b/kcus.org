...
templates['staff'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "  <div class=\"staff-item col-md-6 col-lg-4 pb-2 pb-md-3\">\n    <a class=\"staff-select\" data-target=\""
    + alias4(((helper = (helper = helpers.staffNameFirst || (depth0 != null ? depth0.staffNameFirst : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"staffNameFirst","hash":{},"data":data}) : helper)))
    + "\">\n      <img class=\"img-thumbnail\" src=\""
    ...
    + alias4(((helper = (helper = helpers.staffNameFirst || (depth0 != null ? depth0.staffNameFirst : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"staffNameFirst","hash":{},"data":data}) : helper)))
    + "\">"
    + alias4(((helper = (helper = helpers.staffNameFull || (depth0 != null ? depth0.staffNameFull : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"staffNameFull","hash":{},"data":data}) : helper)))
    + "</a>\n      </div>\n      <div class=\"gray-subheader text-uppercase\">\n        "
    + alias4(((helper = (helper = helpers.staffTitle || (depth0 != null ? depth0.staffTitle : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"staffTitle","hash":{},"data":data}) : helper)))
    + "\n      </div>\n    </div>\n  </div>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    var stack1;
